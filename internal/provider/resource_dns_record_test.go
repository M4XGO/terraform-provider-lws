...
func TestAccDNSRecordResource(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccDNSRecordResourceConfig("terraform-test", "A", "192.0.2.1", "usekenny.site"),
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("lws_dns_record.test", "zone", "usekenny.site"),
			...
			{
				Config: testAccDNSRecordResourceConfig("terraform-test", "A", "192.0.2.2", "usekenny.site"),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func TestAccDNSRecordResource_CNAME(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccDNSRecordResourceConfig("terraform-cname", "CNAME", "usekenny.site.", "usekenny.site"),
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("lws_dns_record.test", "value", "usekenny.site."),
					resource.TestCheckResourceAttr("lws_dns_record.test", "zone", "usekenny.site"),
					resource.TestCheckResourceAttrSet("lws_dns_record.test", "id"),
				),
			},
...
func TestAccDNSRecordResource_TXT(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccDNSRecordResourceConfig("terraform-txt", "TXT", "v=spf1 include:_spf.google.com ~all", "usekenny.site"),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func TestAccDNSRecordResource_AAAA(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccDNSRecordResourceConfig("terraform-ipv6", "AAAA", "2001:db8::1", "usekenny.site"),
				Check: resource.ComposeAggregateTestCheckFunc(
...
func TestAccDNSRecordResource_MX(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccDNSRecordResourceConfig("@", "MX", "10 mail.usekenny.site.", "usekenny.site"),
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("lws_dns_record.test", "name", "@"),
					resource.TestCheckResourceAttr("lws_dns_record.test", "type", "MX"),
					resource.TestCheckResourceAttr("lws_dns_record.test", "value", "10 mail.usekenny.site."),
					resource.TestCheckResourceAttr("lws_dns_record.test", "zone", "usekenny.site"),
					resource.TestCheckResourceAttrSet("lws_dns_record.test", "id"),
				),
			},
...
func TestAccDNSRecordResource_TTL_Values(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccDNSRecordResourceConfigWithTTL("terraform-ttl-test", "A", "192.0.2.10", "usekenny.site", 900),
				Check: resource.ComposeAggregateTestCheckFunc(
			...
			{
				Config: testAccDNSRecordResourceConfigWithTTL("terraform-ttl-test", "A", "192.0.2.10", "usekenny.site", 86400),
				Check: resource.ComposeAggregateTestCheckFunc(
